...
function DialogKey:CreateOptionsFrame()		-- Constructs the options frame
	...
	dontClickSummonsCheckbox:SetScript("OnShow", function(self) self:SetChecked(DialogKey.db.global.dontClickSummons) end)
	dontClickSummonsCheckbox:SetScript("OnClick", function(self) DialogKey.db.global.dontClickSummons = self:GetChecked() end)
	dontClickSummonsCheckbox:SetChecked(DialogKey.db.global.dontClickSummons)
	...
	dontClickDuelsCheckbox:SetScript("OnShow", function(self) self:SetChecked(DialogKey.db.global.dontClickDuels) end)
	dontClickDuelsCheckbox:SetScript("OnClick", function(self) DialogKey.db.global.dontClickDuels = self:GetChecked() end)
	dontClickDuelsCheckbox:SetChecked(DialogKey.db.global.dontClickDuels)
	...
	dontClickRevivesCheckbox:SetScript("OnShow", function(self) self:SetChecked(DialogKey.db.global.dontClickRevives) end)
	dontClickRevivesCheckbox:SetScript("OnClick", function(self) DialogKey.db.global.dontClickRevives = self:GetChecked() end)
	dontClickRevivesCheckbox:SetChecked(DialogKey.db.global.dontClickRevives)
	...
	additionalScroll:SetPoint("TOPLEFT", dontClickRevivesCheckbox, "BOTTOMLEFT", 9, -40)
